...
class airbase_user_warning_typesco extends base_list
{
	function named_list()
	{
		return array(
			...
			'22' => ec('Нарушение форматирования страниц, связности цепочки ответов, некорректный выбор темы или иные действия, затрудняющие чтение. [п.13, +1]'),
			...
			'29' => ec('Потенциально вредоносные для форумов действия (постинг обнажённой натуры, пропаганда суицида и т.п.), +5'),
