...
<div class="alert alert-info text-center" style="padding: 0"><div style="font-size: 1.5rem"><a href="http://forums.balancer.ru/money/">☼{$owner->money()}</a></div><div style="font-size: 0,5rem">Ваш баланс</div></div>
