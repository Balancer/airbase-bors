...
class airbase_user_warning_typesco extends base_list
{
	function named_list()
	{
		return array(
			...
			'10' => ec('Бездоказательное оскорбление человека, не являющегося участником форума [п.11.3, +3]'),
			'18' => ec('Оскорбления национальностей и этносов, шовинистические высказывания [+3]<br />'),
