...
function attach_icon($extension){
	...
	return "<img src=\"{$pun_config['root_uri']}/$icon_url\" width=\"15\" height=\"15\" alt=\"Attachment Icon\" />";	// return the image stuff...
}
...
function attach_create_subfolder($newfolder='')
{
	...
	if(!is_dir($pun_config['attach_basefolder'].$newfolder)){
		...
		if(!mkdir($pun_config['attach_basefolder'].$newfolder, 0775))
