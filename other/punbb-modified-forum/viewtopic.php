...
?>
<script type="text/javascript" src="<?php echo $pun_config['root_uri'];?>/js/common.js"></script>

<a name="page_top"></a>
<div class="linkst">
	<div class="inbox">
		<ul><li><a href="<?php echo $pun_config['root_uri'];?>/index.php"><?php echo $lang_common['Index'] ?></a></li><li>&nbsp;&raquo;&nbsp;<a href="<?php echo $pun_config['root_uri'];?>/viewforum.php?id=<?php echo $cur_topic['forum_id'] ?>"><?php echo pun_htmlspecialchars($cur_topic['forum_name']) ?></a></li><li>&nbsp;&raquo;&nbsp;<?php echo pun_htmlspecialchars($cur_topic['subject']); /*"*/ ?></li></ul>
		<br/>
		<ul><li>
		...
		<div class="inbox">
			<div class="postright">
				<div class="postmsg">
					...
					<div id="post_<?php echo $cur_post['id'];?>_more" style="margin: 0; padding: 0; display: none; font-size: 80%;">
<ul>
