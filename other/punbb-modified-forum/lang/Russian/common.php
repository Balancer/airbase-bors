...
// Notices
'Bad request'			=>	'Неверный запрос. Ссылка, по которой вы пришли неверная, устаревшая или у Вас недостаточный уровень доступа для её просмотра.',
...
'Last visit'			=>	'Ваш предыдущий визит',
