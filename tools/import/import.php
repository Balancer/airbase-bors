...
/*
$blog = bors_load('balancer_board_blog', 2222866);
...
//foreach(bors_find_all('bors_external_feeds_entry', array('target_object_id' => 0, 'is_suspended IS NULL')) as $entry)
...
{
	//$feed = bors_load('bors_external_feed', 4);
