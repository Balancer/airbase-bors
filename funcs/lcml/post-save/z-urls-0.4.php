...
//    error_reporting(E_ALL);
    ...
    // 07.06.04 0.2 исправлена обработка ссылок, "упирающихся" в тэг, например, <li> http://www.ru/<li>
    // 08.06.04 0.3 если сервер теперь не возвращает кодировку, считается, что она - Windows-1251
    // 09.06.04 0.4 Исправлен глюк - в PHP не работает конструкция вида $var |= 'string';
